...
import com.vlad.tutu.repository_list.RepositoryAdapter.RepositoryViewHolder
    ...
    class RepositoryViewHolder(
        ...
        init {
            itemView.setOnClickListener {
                val item = (bindingAdapter as? RepositoryAdapter)?.getItem(bindingAdapterPosition)
